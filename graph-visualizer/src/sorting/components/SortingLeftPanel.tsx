...
export function SortingLeftPanel() {
  const {
    array,
    arraySize,
    inputMode,
        ...
        {activeTab === 'array' ? (
          ...
          <div className="space-y-4 animate-slideInRight">
            ...
            <div className="pt-2 border-t border-[var(--border-color)] space-y-3">
              ...
              <div>
                <h4 className="text-[9px] uppercase font-bold tracking-[0.08em] text-[var(--muted-color)] mb-1.5">
                  Playback Speed
                </h4>
                <div className="flex bg-[var(--input-bg)] border border-[var(--border-color)] rounded-[6px] p-[2px] w-full">
                  {[0.25, 0.5, 0.75, 1, 1.5, 2].map((s) => (
                    <button
                      key={s}
                      onClick={() => setSpeed(s)}
                      className={`flex-1 py-1 text-[9px] font-bold uppercase rounded transition-colors cursor-pointer ${
                        speed === s
